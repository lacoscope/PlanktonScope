...
################################################################################
        ...
        while True:
            ...
            counter+=1
            filename = os.path.join("/home/pi/PlanktonScope/tmp",datetime.now().strftime("%H_%M_%S_%f")+".jpg")
            ...
            client.publish("receiver/image", datetime.now().strftime("%H_%M_%S_%f")+".jpg has been imaged.");
